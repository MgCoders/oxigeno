...
if ( ! class_exists( 'Capital_CSS' ) ) :
    ...
    class Capital_CSS {
        ...
        /**
         * The one instance of Capital_CSS.
         *
         * @var   Capital_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one Capital_CSS instance.
         *
         * @return Capital_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'capital_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `capital_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'capital_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'capital_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'capital_get_css' ) ) :
    /**
     * Return the one Capital_CSS object.
     *
     * @return Capital_CSS    The one Capital_CSS object.
     */
    function capital_get_css() {
        return Capital_CSS::instance();
    }
endif;

add_action( 'init', 'capital_get_css', 1 );