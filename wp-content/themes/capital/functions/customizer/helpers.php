...
function capital_sanitize_choice( $value, $setting ) {
    return $value;
}
 ...
 */
function capital_sanitize_text( $string ) {
    global $allowedtags;
     ...
     */
    apply_filters( 'capital_sanitize_text_allowed_tags', $expandedtags, $string );
